...
in a catalog of \textbf{4{,}267 unique $M \ge 6.5$ events} (4{,}418 CSV rows).
...
\textbf{Primary result --- negative (null/falsification):} on the modern window
(1973--2026, 2{,}041 events), the detector finds on average \textbf{27.0} candidates
...
\begin{keypoints}
  ...
  \item Detector mean = 27.0 on calibrated ETAS null matches $N_\mathrm{obs}=27$ ---
        ...
        (null/falsification result; see \S\ref{sec:limitations}).
...
\item \textbf{ETAS calibrated but detector liberal} --- mean $= 27.0$ matches
      $N_\mathrm{obs}=27$; see \S\ref{sec:detector-liberal} for FPR and search-space detail.
