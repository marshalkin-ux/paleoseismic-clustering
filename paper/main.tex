...
\begin{keypoints}
  ...
  \item 47 detector candidates are indistinguishable from
        ETAS null plus search-space artifacts (see \S\ref{sec:detector-liberal}); tectonic distance failed as a
...
\begin{enumerate}
  ...
  \item 47 detector candidates are indistinguishable
        from ETAS null plus search-space artifacts (see \S\ref{sec:detector-liberal}); tectonic distance is
