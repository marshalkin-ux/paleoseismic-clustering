...
on 2017 GK mainshocks (1973--2026, $M\ge 6.5$): mean $= 27.0$,
$p_\mathrm{ETAS}=1.0$ ($N_\mathrm{obs}=27$): observed candidate count is
\textbf{consistent with} catalog-calibrated local ETAS.
