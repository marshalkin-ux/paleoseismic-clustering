...
\item \textbf{Flinn--Engdahl zones:} large administrative regions; 3 zones $\neq$ 3 tectonic
      provinces; not proof of global structure; future work: min great-circle separation
      $>1000$~km between event pairs.
...
yield 142 cluster candidates before merge; series criteria ($N \ge 4$, $\ge 3$ zones)
are permissive at global scale. On catalog-calibrated ETAS synthetic catalogs without
