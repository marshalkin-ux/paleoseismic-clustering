...
local aftershock-only expectation --- statistically real clustering excess beyond
simple Poisson times, \textbf{not} proof of teleseismic global series
...
\begin{keypoints}
  ...
  \item \textbf{Primary ETAS null} (H\&S 2003, Table~\ref{tab:etas_primary}):
        ...
        exceeds local aftershock expectation; statistically real excess,
        not teleseismic proof.
...
\item \textbf{ETAS local-clustering null} (primary: literature H\&S 2003,
      ...
      (aftershock structure, detector liberalness), but is \textbf{not}
      teleseismic proof.
...
ETAS literature ($n=1000$, H\&S 2003) & Local aftershock-only synthetics & $p_\mathrm{ETAS}\le 0.001$: $N_\mathrm{obs}=27 > \bar{N}\approx 15.4$; local clustering excess, \textbf{not} teleseismic proof \\
...
Literature (H\&S 2003) & 0.008 & 0.08 & $\approx 15.4$ & $\le 0.001$ &
  $N_\mathrm{obs}$ exceeds local aftershock expectation; \textbf{not} teleseismic proof \\
\hline
\end{tabular}
\end{table}
...
local aftershock-only expectation (statistically real clustering excess,
\textbf{not} teleseismic proof).
...
expectation --- statistically real clustering excess, \textbf{not} teleseismic proof.
...
aftershock-only expectation, but this \textbf{does not prove} teleseismic
chains (Table~\ref{tab:etas_decision}).
...
the global multi-regional series hypothesis is \textbf{not confirmed}
(literature ETAS: $p_\mathrm{ETAS}\le 0.001$ reflects local clustering excess,
not teleseismic proof).
...
This \textbf{does not prove} teleseismic global series; it indicates
\textbf{local aftershock clustering excess} under detector rules (mean GC
$>1500$~km, $N\ge 4$) and \textbf{liberal exploratory search} (142 sliding
windows before merge) --- quantitative excess plus detector liberalness, not
a vague ``ETAS does not model inter-plate links'' claim alone.
...
Literature H\&S 2003 (primary) & $\le 0.001$ & Exceeds (mean $\approx 15.4$) &
  Statistically real local aftershock clustering excess; \textbf{not} teleseismic proof \\
...
Literature $p\le 0.001$ & ETAS test & Local clustering excess, not teleseismic proof \\
\hline
\end{tabular}
\end{table}
...
\textbf{real local clustering excess} under H\&S parameters but does \textbf{not}
overturn the null on the global-series hypothesis (no mechanism, GC-only gates).
...
exceeds mean $\approx 15.4$ ($p_\mathrm{ETAS}\le 0.001$) --- statistically real
...
\begin{enumerate}
  ...
  \item \textbf{Primary ETAS null} (literature H\&S 2003): mean $\approx 15.4$,
        ...
        aftershock expectation; statistically real excess,
        \textbf{not} teleseismic proof (Table~\ref{tab:etas_decision}).
...
\noindent\textbf{Reproducibility negative control only --- not inference.}
...
the same catalog (24-event WLS on GK aftershocks); \textbf{not} independent
evidence and \textbf{not} used for inference.
