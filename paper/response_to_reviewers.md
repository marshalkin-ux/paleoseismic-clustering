...
- **Первичная null для выводов:** литература H&S 2003 (μ=0,008, K=0,08), p_ETAS≤0,001, mean≈15,4 — отклонение от ETAS: кластеризация вне модели; циркум-Тихоокеан; возможные региональные афтершоки; не глобальные цепочки.
...
- **Добавлен prose-анализ** (2–3 абзаца RU+EN): η₀ → GK-метки, N=27 стабилен; b=0,911 → N=27, upstream не пересчитан; нет spatial MLE → только лит. null; 142 окна → либеральность; p≤0,001 → кластеризация вне ETAS (циркум-Тихоокеан), не опровержение гипотезы глобальных серий.
