...
def build(s):
    ...
    tbl_data = [
        ...
        [Paragraph("S191", s["tbl_cell"]), Paragraph("15", s["tbl_cell"]),
         Paragraph("4", s["tbl_cell"]), Paragraph("8.4", s["tbl_cell"]),
         Paragraph("2007\u20132022", s["tbl_cell"]),
         Paragraph("Пост-суматранская активация", s["tbl_cell"])],
    ]
