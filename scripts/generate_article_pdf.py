...
def build(s):
    ...
    story.append(Paragraph(
        ...
        "4267\u00a0уникальных событий M\u22656.5 (2150\u00a0г.\u00a0до\u00a0н.\u044d.\u20132026\u00a0гг.; "
        ...
        "каталогов, p_ETAS=0.0000, FPR=0/100); "
    ...
    story.append(Paragraph(
        ...
        "~151 NOAA M&lt;6.5 rows excluded from clustering; 2150\u00a0BCE\u20132026\u00a0CE), "
        ...
        "(100 synthetic catalogs without long-range coupling, p_ETAS=0.0000), "
    ...
    story.append(Paragraph(
        "<b>ETAS-параметры (не откалиброваны на каталоге):</b> "
        "defaults Helmstetter &amp; Sornette 2003 (mu=0.008, K=0.08, alpha=1.0, "
        "c=0.005 сут., p=1.1); не подгонка на 2041 событие "
        "(results/etas_calibration_note.md). MLE mu на каталоге ~0.105 соб/сут. "
        "vs default 0.008; полный ETAS MLE и multiseed — перспектива.",
        s["body"]
    ))
    ...
    story.append(Paragraph(
        ...
        "<b>S170 Delta CFS (Sec. 5.4):</b> Okada 1985, Sumatra 2004 "
        "(3.3°N 95.8°E, GCMT 320°/10°/110°); 79 приёмников 2004–2016. "
        "Япония n=63: mean +0.008 kPa, median +0.007 kPa, range 0.003–0.023 kPa, "
        "100% promoting; Алеуты n=16: mean +0.000065 kPa (на 2 порядка меньше). "
        "Значения &lt;&lt; 0.1 bar — статика недостаточна; нужны динамика/вязкоупругость. "
        "fig06_cfs_s170.png. "
    ...
    conclusions = [
        ...
        ("5.", "Delta CFS S170: Япония +0.008 kPa (n=63), Алеуты +0.000065 kPa (n=16); "
               "promoting, но &lt;&lt; 0.1 bar (fig06_cfs_s170.png)."),
        ("6.", "<b>Интерпретационная вилка:</b> (a)\u00a0если \u03b7-связи реальны \u2014 "
               ...
               "Совместное появление может отражать общую тектоническую нагрузку."),
    ]
    ...
    story.append(Paragraph(
        ...
        "<b>Перспективы:</b> Delta CFS для S047, S095; полный ETAS MLE; multiseed; Zenodo.",
        s["body_ni"]
    ))
