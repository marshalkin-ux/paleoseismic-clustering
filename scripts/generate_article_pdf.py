...
def build(s):
    ...
    story.append(Paragraph(
        ...
        "(27\u00a0на современном окне). <b>Первичная ETAS-null</b> для теста гипотезы — "
    ...
    story.append(Paragraph(
        ...
        "(b) ETAS H&amp;S: N=27 &gt; mean\u224815,4, p\u22640,001. "
        "(c) Гипотеза глобальных серий: <b>не подтверждена</b>. "
        "(d) WLS-контроль (Прил.\u00a0B): p=1,0 \u2014 falsification, не первичная null.",
        s["body_ni"]
    ))
    ...
    story.append(Paragraph(
        ...
        "<b>ETAS (первичная).</b> Лит. H&amp;S: mean\u224815,4, p\u22640,001, N=27. "
    ...
    story.append(Paragraph(
        "<b>WLS-контроль (Прил.\u00a0B):</b> p_ETAS=1,0, mean=27=N_obs \u2014 связка "
        "детектор+калибровка; поддерживает отрицательный вывод; WLS недопустима для inference; "
        "первичная null \u2014 лит. H&amp;S до spatial MLE.",
        s["body_ni"]
    ))
    story.append(Paragraph(
        "<b>Отрицательный результат:</b> детектор либерален; лит. ETAS p\u22640,001, N=27. "
        "Интерпретация ETAS \u2014 не доказательство глобальных серий. "
    ...
    story.append(Paragraph(
        ...
        "p_ETAS≤0,001 — отклонение от литературной ETAS указывает на кластеризацию вне модели; "
        "остатки ETAS не анализировались; не доказательство глобальных серий. "
        "Гипотеза о глобальных сериях <b>не подтверждается</b>. "
        "WLS-контроль: p=1,0 \u2014 falsification framing, не первичная null. "
    ...
    lim_rows = [
        ...
        [
            "Лит. p\u22640,001",
            "ETAS-тест",
            "Кластеризация вне ETAS; циркум-Тихоокеан; не глобальные цепочки",
        ],
    ]
