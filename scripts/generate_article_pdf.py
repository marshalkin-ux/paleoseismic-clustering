...
def build(s):
    ...
    story.append(Paragraph(
        ...
        "Минимальное удаление ZBZ подтверждает, что декластеризация не критический развилочный выбор.",
        s["body"]
    ))
    ...
    steps = [
        ...
        ("3.", "Критерий кандидата: N>=4; M>=6.5; mean pairwise GC>1500 km."),
    ...
    story.append(Paragraph(
        ...
        "Литературные defaults (Helmstetter &amp; Sornette 2003) \u2014 только для сравнения. "
        "Multiseed: seeds 42\u201351, n=1000 кат./seed (results/etas_multiseed.json).",
        s["body"]
    ))
