...
def build_story(styles):
    ...
    meta_data = [[
        ...
        Paragraph("<b>1973–2026 CE</b> (primary window)", S["body_center"]),
    ...
    tbl_data = [
        ...
        [
            ...
            Paragraph("1973–2026 (2041 events)", S["body"]),
    ...
    story.append(Paragraph(
        "Полный каталог 1900–2026 (<b>4267 событий M≥6.5</b>, 4418 CSV-строк) "
        "выдаёт <b>47 кандидатов детектора</b> (не «открытые серии») в трёх временны́х окнах:",
        S["body"]
    ))
    key_results = [
        "• Современный период (1973–2026): <b>27 кандидатов</b>, permutation p &lt; 0.0001; ETAS mean=27,0, p<sub>ETAS</sub>=1,0",
        "• Ранний инструментальный (1900–1972): <b>15 кандидатов</b>, p = 0.007 — неполнота каталога до ~1960",
        "• Исторический (до 1900): <b>5 кандидатов</b>, p = 0.46 (не для заявлений о значимости)",
