...
| FDR BH (q=0.05) | 45/47 (N=47 post-hoc; **не** discovery claim) |
| Mc / b | 6.55 / 0.911 ± 0.018 |

**Вывод:** избыточной глобальной структуры сверх ETAS-подобной локальной кластеризации **нет**; кандидаты неотличимы от ETAS-null и артефактов либерального поиска.
